...
public final class Filme {
    ...
    public Filme(String id, String titulo, int ano, int duracaoMinutos, Collection<Genero> generos, ClassificacaoEtaria classificacaoEtaria, Idioma idioma, int popularidade) {
